...
def get_text_from_screen(p1, p2):
    """
    ...
    try:
        ...
        save_dir = r"C:\Users\RLLAB\Desktop\Auto Ludii Fighter\screenshots"
...
def attach_minizero(pos_data, sc, ts):
    """
...
def check_and_terminate(pos_data):
    """
    ...
    recognized_text = get_text_from_screen(p1, p2)
...
def reopen_ludii(pos_data):
    """
    關閉並重新開啟 Ludii 應用程式。
    """
    check_and_terminate(pos_data)
...
def check_main_console_disconnect(pos_data):
    """
...
def auto_click_actions(config_data, pos_data):
    ...
    try:
        total_steps = replicate_num * len(model_file_names)
        step_count = 0
            ...
            for model_name in model_file_names:
                ...
                while True:
                    ...
                    while attach_success == False:
                        ...
                        # if log_path exists, read content
                        ...
                        attach_minizero(pos_data, step_count, total_steps)
                        ...
                        text_check = get_text_from_screen(p1, p2)
                                ...
                                while not wait_for_internet():
                                    ...
                                    if time.time() - offline_start_time >= 5 and need_reestablish_connection == False:
                                        ...
                                        if remaining_fights == 0:
                                            break
                                        need_reestablish_connection = check_and_terminate(pos_data)
...
if __name__ == "__main__":
    ...
    if os.path.exists(config_file):
        ...
        try:
            ...
            config_data['log_path'] = config.get('Settings', 'log_path', fallback="")
